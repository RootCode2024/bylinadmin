    ...
    >
      ...
      <div class="flex items-end justify-between mt-5">
        <div>
          ...
          <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">{{ totalCustomers }}</h4>
        </div>
...
const totalCustomers = computed(() => dashboardStore.totalCustomers ?? 0)
const totalOrders = computed(() => dashboardStore.totalOrders ?? 0)
</script>

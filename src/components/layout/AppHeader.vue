  ...
  >
    <div class="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
      ...
      >
        ...
        <!-- Date et heure en temps réel avec fuseau horaire -->
        <div class="hidden lg:flex lg:items-center lg:gap-2">
          ...
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M10 1.66699C5.3975 1.66699 1.66667 5.39782 1.66667 9.99999C1.66667 14.6025 5.3975 18.3333 10 18.3333C14.6025 18.3333 18.3333 14.6025 18.3333 9.99999C18.3333 5.39782 14.6025 1.66699 10 1.66699ZM0.833252 9.99999C0.833252 4.92415 4.92409 0.833328 10 0.833328C15.0758 0.833328 19.1666 4.92415 19.1666 9.99999C19.1666 15.0758 15.0758 19.1667 10 19.1667C4.92409 19.1667 0.833252 15.0758 0.833252 9.99999ZM10.8333 5.83333C10.8333 5.41912 10.4975 5.08333 10.0833 5.08333C9.66912 5.08333 9.33325 5.41912 9.33325 5.83333V10C9.33325 10.4142 9.66912 10.75 10.0833 10.75H13.3333C13.7475 10.75 14.0833 10.4142 14.0833 10C14.0833 9.58579 13.7475 9.25 13.3333 9.25H10.8333V5.83333Z"
              fill=""
            />
          </svg>
...
onMounted(() => {
  ...
  timeInterval.value = setInterval(updateTime, 1000) // Mise à jour chaque seconde
})
